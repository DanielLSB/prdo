...
public class Producto {
    ...
    public Producto(String producto, String descripcion, int id_marca, int existencia, float precio_costo, float precio_venta,String imagen) {
    ...
    public DefaultTableModel leer(){
        ...
        try{
            cn = new Conexion();
            String query = "select e.id_producto as id,e.producto,p.marca,e.descripcion,e.precio_costo,e.precio_venta,e.existencia,e.imagen, e.id_marca  from productos as e inner join marcas as p on e.id_marca = p.id_marca order by id_producto;";
            cn.abrir_conexion();
...
String encabezado[] = {"id","producto","marca","descripcion","precio_costo","precio_venta","existencia","id_marca"};
  ...
  public int agregar(){
    ...
    cn = new Conexion();
    String query="INSERT INTO productos(producto,id_marca,descripcion,precio_costo,precio_venta,existencia,imagen) VALUES(?,?,?,?,?,?,?);";
    cn.abrir_conexion();
      ...
      parametro.setString(3, getDescripcion());
       parametro.setFloat(4, getPrecio_costo());
        parametro.setFloat(5, getPrecio_venta());
         ...
         parametro.setString(7, getImagen());
